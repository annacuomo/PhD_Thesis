...
More recently, similar approaches have been applied to RNA sequencing data to find variants associated with expression level, called expression quantitative trait loci (eQTL).
