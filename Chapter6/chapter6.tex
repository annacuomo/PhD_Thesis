...
To test for GxE interactions we apply the same strategy that is used in the StructLMM method, which in turn adopts the strategy described in Rao et al \cite{rao1948large}.
...
instead.
As in SKAT \cite{wu2011rare}, we use the Davies exact method \cite{davies1980algorithm} to compute the corresponding p values.

SKAT \cite{wu2011rare}
SKAT-O \cite{}
